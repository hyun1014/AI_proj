...
target_model = "NLP_model/learned_model_prototype4_1.h5"
...
# Load selected_word
with open("NLP_model/selected_word_prototype4_1.json", "r") as sf:
...
print("Epoch=100 / seleted_word.length=100")
